...
hp_settings = {
    'soft_horizon': [1e6],  # logical episodes every soft_horizon steps without resetting env
    'ppo_batch_size': [64],
}
env_configs = {
...
experiment_name = 'PPO_stationary_' + env_name + '/default'  # used for creating log and save paths
