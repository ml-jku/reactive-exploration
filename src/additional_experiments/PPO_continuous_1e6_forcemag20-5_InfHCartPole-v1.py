...
experiment_name = 'PPO_continuous_1e6_' + env_name + '/forcemag20-5'  # used for creating log and save paths
...
def run_training_instance(args):
    ...
    model = PPO('MlpPolicy', env, verbose=1, batch_size=hp_dict['policy_batch_size'],
