...
class CSQL(OffPolicyAlgorithm):
    """
    Deep Curiosity Soft Q-Network (CSQL)
    ...
    def train(self, gradient_steps: int, batch_size: int = 100) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            with th.no_grad():
                ...
                # 1-step TD target
                target_q_values = norm_combined_rewards + (1 - replay_data.dones) * self.gamma * next_q_values
    ...
    def learn(
            ...
            tb_log_name: str = "CSQL",
            eval_log_path: Optional[str] = None,
            reset_num_timesteps: bool = True,
    ) -> OffPolicyAlgorithm:

        return super(CSQL, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(CSQL, self)._excluded_save_params() + ["q_net", "q_net_target"]
