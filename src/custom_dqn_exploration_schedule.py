...
from custom_off_policy_algorithm import OffPolicyAlgorithm
...
class DQN(OffPolicyAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        if self.exploration_schedule is None:
            self.exploration_schedule = lambda a: self.exploration_final_eps
    ...
    def _on_step(self) -> None:
        ...
        self.exploration_rate = self.exploration_schedule(self.num_timesteps)
