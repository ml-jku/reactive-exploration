...
from src.custom_buffers import PrioritizedExperienceReplayBuffer
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def __init__(
        ...
        self.replay_buffer = None  # type: Optional[PrioritizedExperienceReplayBuffer]
    ...
    def _setup_model(self) -> None:
        ...
        self.replay_buffer = PrioritizedExperienceReplayBuffer(
            ...
            alpha=self.alpha,
            beta=self.beta,
            beta_increment_per_sampling=self.beta
        )
    ...
    def load_replay_buffer(self, path: Union[str, pathlib.Path, io.BufferedIOBase]) -> None:
        ...
        assert isinstance(self.replay_buffer,
                          PrioritizedExperienceReplayBuffer), "The replay buffer must inherit from PrioritizedExperienceReplayBuffer class"
    ...
    def collect_rollouts(
            ...
            replay_buffer: Optional[PrioritizedExperienceReplayBuffer] = None,
            log_interval: Optional[int] = None,
    ) -> RolloutReturn:
        """
        Collect experiences and store them into a PrioritizedExperienceReplayBuffer.
